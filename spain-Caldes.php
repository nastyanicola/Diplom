...
<body>
    ...
    <div class="hero-contry">
        ...
        <p class="subtitle-contry">Кальдас-де-Малавелья, Гольф курорт PGA</p>
    </div>
    ...
    <div class="villa">
        <div class="villa-top">
            ...
            <div class="villa-image">
                <img src="./img/caldes1.png" alt="">
            </div>

            <div class="villa-info">
                <p class="villa-text">
                    Просторная гостиная с выходом на террасу и бассейн идеально подходит для отдыха. В доме четыре
                    спальни, каждая со собственной ванной комнатой и гардеробной<br><br>

                    В отдельной зоне wellness расположены сауна и крытый бассейн, где можно расслабляться в любое время
                    года.
                </p>

                <div class="villa-bottom">
                    <p class="villa-price">25 000 € / сутки</p>
        ...
        <div class="villa-gallery">
            <div class="left-img">
                <img src="img/caldes2.png">
                <img src="img/caldes3.png">
                <img src="img/caldes4.png">

            </div>

            <div class="right-img">
                <img src="img/caldes5.png">
                <img src="img/caldes6.png">
                <img src="img/caldes7.png">
                <img src="img/caldes8.png">
            </div>
        </div>
    </div>
   ...
   <div id="villaModal" class="villa-modal">
        <div class="villa-modal__box">
            ...
            <form id="villaForm">
                ...
                <input type="hidden" name="base" id="villaBase" value="Вилла Испания, Кальдас-де-Малавелья, Гольф курорт PGA">
