...
<body>
    ...
    <div class="hero-contry">
        <p class="title-hero-contry">Испания</p>
        <p class="subtitle-contry">Коста-Брава, Ллорет-де-Мар</p>
    </div>
    ...
    <div class="villa">
        <div class="villa-top">
            ...
            <div class="villa-image">
                <img src="./img/lloret1.png" alt="">
            </div>

            <div class="villa-info">
                <p class="villa-text">
                    Первый этаж - просторная столовая с выходом на крытую террасу (панорамный вид на море) и к бассейну,
                    оборудованная кухня (посудомоечная машина, кофеварка, СВЧ, чайник, винный шкаф и все необходимое)
                    <br><br>

                    Второй этаж - спалья с двуспальной кроватью и раскладным диваном, душевой, выходом на балкон с
                    потрясающим видом на море, прачечная со стиральной/сушильной машинами<br><br>

                    Третий этаж - прихожая с панорамным видом на море и сосны, паркинг
                </p>

                <div class="villa-bottom">
                    <p class="villa-price">8 800 € / неделя</p>
        ...
        <div class="villa-gallery">
            <div class="left-img">
                <img src="img/lloret2.png">
                <img src="img/lloret3.png">
                <img src="img/lloret4.png">

            </div>

            <div class="right-img">
                <img src="img/lloret5.png">
                <img src="img/lloret6.png">
                <img src="img/lloret7.png">
                <img src="img/lloret8.png">
            </div>
        </div>
    </div>
    ...
    <div id="villaModal" class="villa-modal">
        <div class="villa-modal__box">
            ...
            <form id="villaForm">
                ...
                <input type="hidden" name="base" id="villaBase" value="Вилла Испания, Коста-Брава, Ллорет-де-Мар">
