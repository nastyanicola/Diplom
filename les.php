...
<body>
    ...
    <div class="hero container">
        <h1 class="title-hero">База отдыха Les
        </h1>
        <p class="subtitle">Московская область, Клинский район,<br>
            деревня Анненка</p>
    </div>
    ...
    <div class="house">
        <div class="house-inner">
            ...
            <div class="house-image">
                <img id="mainImage1" src="img/les1.png" alt="">
                <div class="thumbs">
                    <img src="img/les1.png" class="thumb active" data-target="mainImage1">
                    <img src="img/les2.png" class="thumb" data-target="mainImage1">
                    <img src="img/les3.png" class="thumb" data-target="mainImage1">
                    <img src="img/les4.png" class="thumb" data-target="mainImage1">
                    <img src="img/les5.png" class="thumb" data-target="mainImage1">
                    <img src="img/les6.png" class="thumb" data-target="mainImage1">
                </div>
            </div>

            <div class="house-text">
                <h2>Private House «Misty Forest»</h2>

                <ul class="house-list">
                    <li>Тёплые полы, батареи и кондиционер</li>
                    <li>Кухня полностью укомплектована</li>
                    <li>Санузел с душевой кабиной, феном</li>
                    <li>Бутилированная вода — бесплатно</li>
                    <li>Wi-Fi, чтобы быть на связи, если потребуется</li>
                    <li>Парковочное место рядом с домом</li>

                </ul>

                <p class="house-subtitle">Баня и купель</p>

                <ul class="house-list">
                    <li>Баня на дровах — 5 900 ₽</li>
                    <li>Горячая купель — 5 900 ₽</li>
                    <li>Холодная купель — 4 750 ₽</li>
                    <li>Баня с горячей купелью — 9 500 ₽</li>
                    <li>Баня с холодной купель — 7 900 ₽</li>
                </ul>

                <p class="note">
                    Цена указана за 2 человек за 3 часа, каждый дополнительный человек + 500 руб.
                </p>

                <div class="house-bottom">
                    <p class="house-price">25 000 ₽ / сутки</p>
                    <a href="#" class="house-btn" data-house="База отдыха Les - Misty Forest">Забронировать</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="house">
        <div class="house-inner">
            ...
            <div class="house-image">
                <img id="mainImage1" src="img/les7.png" alt="">
                <div class="thumbs">
                    <img src="img/les7.png" class="thumb active" data-target="mainImage1">
                    <img src="img/les8.png" class="thumb" data-target="mainImage1">
                    <img src="img/les9.png" class="thumb" data-target="mainImage1">
                    <img src="img/les10.png" class="thumb" data-target="mainImage1">
                    <img src="img/les11.png" class="thumb" data-target="mainImage1">
                    <img src="img/les12.png" class="thumb" data-target="mainImage1">
                </div>
            </div>

            <div class="house-text">
                <h2>Private House «Emerald Woods»</h2>
                ...
                <div class="house-bottom">
                    <p class="house-price">25 000 ₽ / сутки</p>
                    <a href="#" class="house-btn" data-house="База отдыха Les - Emerald Woods">Забронировать</a>
                </div>
            </div>
        </div>
    </div>
