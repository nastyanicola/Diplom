...
<body>
    ...
    <div class="hero-contry">
        ...
        <p class="subtitle-contry">Стреза, виа Ведаско</p>
    </div>
    ...
    <div class="villa">
        <div class="villa-top">
            ...
            <div class="villa-image">
                <img src="./img/stresa1.png" alt="">
            </div>

            <div class="villa-info">
                <p class="villa-text">
                    В нескольких минутах от центра города, расположена на первом холме, в 3 минутах от озера на
                    машине.<br><br>

                    На цокольном этаже расположена гостевая зона с двумя спальнями, ванной комнатой, гостиной с
                    отдельным
                    выходом в сад.<br><br>

                    На первом этаже — гостиная, кухня, столовая и спа-зона с бассейном.<br><br>

                    Второй этаж: три спальни с отдельными ванными комнатами.<br><br>
                ...
                <div class="villa-bottom">
                    <p class="villa-price">20 000 € / сутки</p>
        ...
        <div class="villa-gallery">
            <div class="left-img">
                <img src="img/stresa2.png">
                <img src="img/stresa3.png">
                <img src="img/stresa4.png">
            </div>

            <div class="right-img">
                <img src="img/stresa5.png">
                <img src="img/stresa6.png">
                <img src="img/stresa7.png">
                <img src="img/stresa8.png">
    ...
    <div id="villaModal" class="villa-modal">
        <div class="villa-modal__box">
            ...
            <form id="villaForm">
                ...
                <input type="hidden" name="base" id="villaBase" value="Вилла Италия, Стреза, виа Ведаско">
