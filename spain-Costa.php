...
<body>
    ...
    <div class="hero-contry">
        ...
        <p class="subtitle-contry">Кастель-Пладжа-де-Аро</p>
    </div>
    ...
    <div class="villa">
        <div class="villa-top">
            ...
            <div class="villa-image">
                <img src="./img/costa1.png" alt="">
            </div>

            <div class="villa-info">
                <p class="villa-text">
                    Коттедж площадью 800 м.кв. на территории 1.5 гектара в первой линии моря на
                    побережье Коста Брава в элитной урбанизации города Льорет де Мар - Кала Канейяс<br><br>

                    На цокольном этаже расположена гостевая зона с двумя спальнями, ванной комнатой, гостиной<br><br>

                    На этаже - главный вход в двойную гостиную, кухню, соединенную со столовой


                </p>

                <div class="villa-bottom">
                    <p class="villa-price">2 350 € / месяц</p>
        ...
        <div class="villa-gallery">
            <div class="left-img">
                <img src="img/costa2.png">
                <img src="img/costa5.png">

            </div>

            <div class="right-img">
                <img src="img/costa3.png">
                <img src="img/costa4.png">
     ...
     <div id="villaModal" class="villa-modal">
        <div class="villa-modal__box">
            ...
            <form id="villaForm">
                ...
                <input type="hidden" name="base" id="villaBase" value="Испания, Кастель-Пладжа-де-Аро">
