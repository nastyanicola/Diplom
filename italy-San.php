...
<body>
    ...
    <header class="header-san">
        <div class="header">
            ...
            <?php else: ?>
                <a href="#" onclick="openAuth(); return false;" class="btn-login">Войти</a>
            <?php endif; ?>
        </div>
    </header>
    ...
    <div class="hero-contry">
        ...
        <p class="subtitle-contry">Сан-Феличе-Чирчео</p>
    </div>
    ...
    <div class="villa">
        <div class="villa-top">
            ...
            <div class="villa-image">
                <img src="./img/san1.png" alt="">
            </div>

            <div class="villa-info">
                <p class="villa-text">
                    Шикарная вилла с бассейном и видом на море<br><br>

                    Большой просторный салон, обеденный зал, кухня, 2 спальни и 2 ванные комнаты
                    на нижнем уровне (с выходом к бассейну) находятся еще две спальни, 1 ванная, гардеробная<br><br>

                    Первый этаж отведён под зону отдыха. Интерьер оформлен элегантно: белые кожаные диваны Chesterfield,
                    . Кухня полностью оборудована профессиональной техникой из нержавеющей стали<br><br>

                    Коттедж включает бассейн и джакузи, откуда открывается великолепный вид на озеро<br><br>
                </p>
                ...
                <div class="villa-bottom">
                    <p class="villa-price">50 000 € / сутки</p>
        ...
        <div class="villa-gallery">
            <div class="left-img">
                ...
                <img src="img/san3.png">
                <img src="img/san4.png">
            </div>

            <div class="right-img">
                <img src="img/san5.png">
                <img src="img/san6.png">
                <img src="img/san7.png">
                <img src="img/san8.png">
    ...
    <div id="villaModal" class="villa-modal">
        <div class="villa-modal__box">
            ...
            <form id="villaForm">
                ...
                <input type="hidden" name="base" id="villaBase" value="Вилла Италия, Сан-Феличе-Чирчео">
