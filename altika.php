...
<body>
    ...
    <div class="hero container">
        <h1 class="title-hero">База отдыха Altika</h1>
        <p class="subtitle">Московская область, Истринский район,<br>
            деревня Лужки</p>
    </div>
    ...
    <div class="house">
        <div class="house-inner">
            ...
            <div class="house-image">
                <img id="mainImage1" src="img/altika1.png" alt="">
                <div class="thumbs">
                    <img src="img/altika1.png" class="thumb active" data-target="mainImage1">
                    <img src="img/altika2.png" class="thumb" data-target="mainImage1">
                    <img src="img/altika3.png" class="thumb" data-target="mainImage1">
                    <img src="img/altika4.png" class="thumb" data-target="mainImage1">
                    <img src="img/altika5.png" class="thumb" data-target="mainImage1">
                    <img src="img/altika6.png" class="thumb" data-target="mainImage1">
                </div>
            </div>

            <div class="house-text">
                <h2>Private House «Forest Hill»</h2>
                <ul class="house-list">
                    <li>Панорамные окна с видом на природу</li>
                    <li>Полностью оборудованная кухня</li>
                    <li>Камин для уютных вечеров</li>
                    <li>Аудиосистема и Smart TV</li>
                    <li>Отдельная зона для барбекю с мангалом</li>
                    <li>Парковочное место рядом с домом</li>
                </ul>
                <p class="house-subtitle">Дополнительные услуги</p>
                <ul class="house-list">
                    <li>Аренда гриль-зоны — 2 500 ₽</li>
                    <li>Набор для барбекю (уголь, розжиг, решётка) — 1 200 ₽</li>
                    <li>Прокат велосипедов — 800 ₽ / день</li>
                    <li>Игровая приставка — 1 500 ₽</li>
                    <li>Кинопроектор — 2 500 ₽</li>
                </ul>
                <p class="note">
                    Услуги предоставляются по предварительному бронированию
                </p>
                <div class="house-bottom">
                    <p class="house-price">35 000 ₽ / сутки</p>
                    <a href="#" class="house-btn" data-house="База отдыха Altika - Forest Hill">Забронировать</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="house">
        <div class="house-inner">
            ...
            <div class="house-image">
                <img id="mainImage1" src="img/altika7.png" alt="">
                <div class="thumbs">
                    <img src="img/altika7.png" class="thumb active" data-target="mainImage1">
                    <img src="img/altika8.png" class="thumb" data-target="mainImage1">
                    <img src="img/altika9.png" class="thumb" data-target="mainImage1">
                    <img src="img/altika10.png" class="thumb" data-target="mainImage1">
                    <img src="img/altika11.png" class="thumb" data-target="mainImage1">
                    <img src="img/altika12.png" class="thumb" data-target="mainImage1">
                </div>
            </div>

            <div class="house-text">
                <h2>Private House «Golden Meadow»</h2>
                ...
                <div class="house-bottom">
                    <p class="house-price">35 000 ₽ / сутки</p>
                    <a href="#" class="house-btn" data-house="База отдыха Altika - Golden Meadow">Забронировать</a>
                </div>
            </div>
        </div>
    </div>
